...
| Tool | Description |
|------|-------------|
| [Harness-Lint](https://github.com/renjianguojinqianfan/harness-lint) | Protocol verifier for PBH ecosystem, covering 10 AI code defect rules with attribution-anchored reports |
