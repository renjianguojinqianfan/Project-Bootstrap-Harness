...
2. Start the server: `python -m {package_name}.main`
3. Open `http://localhost:8000/health` in your browser
...
- Use `fastapi.testclient.TestClient` for all endpoint tests
